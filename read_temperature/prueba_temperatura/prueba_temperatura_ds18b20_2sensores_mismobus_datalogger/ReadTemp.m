...
% data = readtable("E:\Users\cargall2\sd_prueba_datalogger\read_temperature\prueba_temperatura\prueba_temperatura_ds18b20_2sensores_mismobus_datalogger\TEST2.csv", opts);
data = readtable("E:\Users\cargall2\sd_prueba_datalogger\read_temperature\prueba_temperatura\prueba_temperatura_ds18b20_2sensores_mismobus_datalogger\TEST4.csv", opts);
...
hold on 
yyaxis right
plot(time_stamp_represent, voltage, 'c.');
ylabel('voltage')
legend("red temperature sensor", " blue temperature sensor", "ambient temperature sensor", "voltage")
% close all
